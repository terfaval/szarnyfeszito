...
This project uses [`next/font/local`](https://nextjs.org/docs/app/building-your-application/optimizing/fonts#local-fonts) to load local font files (no Google Fonts dependency during build).
